...
public class ArraySet<E> implements SimpleSet<E> {
	...
	public boolean add(E x) {
		if (data.contains(x)) { /**If it already contains the element it will return false. */
			return false;
		} else {
			return (data.add(x)); /**If it did not already contain it, it will first add the element and then return true. */
		}
